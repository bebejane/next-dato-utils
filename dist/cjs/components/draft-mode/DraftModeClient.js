...
function DraftMode({ enabled, draftUrl, tag, path, actions }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: DraftModeClient_module_scss_1.default.draftMode, children: [(0, jsx_runtime_1.jsxs)("div", { className: DraftModeClient_module_scss_1.default.label, children: [(0, jsx_runtime_1.jsx)("img", { width: "20", height: "20" }), (0, jsx_runtime_1.jsx)("div", { children: "Draft Mode" })] }), (0, jsx_runtime_1.jsxs)("button", { onClick: () => startTransition(() => {
                ...
                }), children: ["Exit", loading && (0, jsx_runtime_1.jsx)("div", { className: DraftModeClient_module_scss_1.default.loading, children: (0, jsx_runtime_1.jsx)("div", { className: DraftModeClient_module_scss_1.default.loader }) })] })] }));
}
