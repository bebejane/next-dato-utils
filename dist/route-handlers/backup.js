...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./vercel-cron-auth", "@datocms/cma-client-browser"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const vercel_cron_auth_1 = __importDefault(require("./vercel-cron-auth"));
    const cma_client_browser_1 = require("@datocms/cma-client-browser");
    const backup = async (req) => {
        return (0, vercel_cron_auth_1.default)(req, async (req) => {
            ...
            try {
                ...
                const maxBackups = params.get('max') ? parseInt(params.get('max')) : 1;
                const backupPrefix = 'auto-backup-';
                const client = (0, cma_client_browser_1.buildClient)({ environment: process.env.DATOCMS_ENVIRONMENT, apiToken: process.env.DATOCMS_API_TOKEN, requestTimeout: 3000 });
