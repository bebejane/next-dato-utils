    ...
    return (_jsxs("html", { children: [_jsxs("head", { children: [_jsx("style", { children: `
          ...
          .error{
            color:red;
                                                            ...
                                                            .map((p, i) => (_jsxs(React.Fragment, { children: [_jsx("span", { title: p, children: p }), _jsx("br", {})] }, i))) }), _jsx("td", { children: r.revalidate?.paths?.map((p, i) => (_jsxs(React.Fragment, { children: [_jsx("span", { title: p, children: p }), _jsx("br", {})] }, i))) })] }, idx)))] }) })] }) }), _jsxs("div", { className: 'left', children: [_jsxs("section", { children: [_jsx("h3", { children: "Config" }), _jsx("hr", {}), _jsx("strong", { children: "Name:" }), " ", results.site?.name, _jsx("br", {}), _jsx("strong", { children: "Locales:" }), " ", results.site?.locales.join(', '), _jsx("br", {}), _jsx("strong", { children: "Domain:" }), ' ', _jsx("a", { href: `https://${results.site.internal_domain}`, target: '_blank', children: results.site?.internal_domain }), _jsx("br", {}), _jsx("strong", { children: "SEO" }), results.site?.locales.map((locale) => {
                                        ...
                                        return (_jsxs(React.Fragment, { children: [_jsx("strong", { children: locale }), _jsxs("ul", { children: [_jsxs("li", { children: ["Site name: ", seo?.site_name] }), _jsxs("li", { children: ["Title: ", seo?.fallback_seo?.title] }), _jsxs("li", { children: ["Description: ", seo?.fallback_seo?.description] }), _jsxs("li", { children: ["Image: ", seo?.fallback_seo?.image] })] }, locale)] }, locale));
